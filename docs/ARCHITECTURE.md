...
## 서비스 구성
- `market/api`: FE용 단건, 다건, 설정 universe, 시장별, 계좌별 watchlist/보유종목 실시간 시세 REST API
- `market/application`: Hana-OmniLens-API snapshot을 현지 사용자 컨텍스트, 계좌별 watchlist/보유종목, market filter에 맞게 조합하는 application service
