...
@Component
public class RestOmniLensOrderBookClient implements OmniLensOrderBookClient {
	...
	public RestOmniLensOrderBookClient(
	...
	@Override
	public OmniLensOrderBookResponse getOrderBook(String stockCode, String currency) {
		try {
			OmniLensApiResponse<OmniLensOrderBookResponse> response = retryer.execute("market.getOrderBook", () -> restClient.get()
					.uri(uriBuilder -> uriBuilder
							.path("/api/v1/market/stocks/{stockCode}/orderbook")
