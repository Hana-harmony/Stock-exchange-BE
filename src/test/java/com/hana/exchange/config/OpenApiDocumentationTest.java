...
class OpenApiDocumentationTest {
	...
	void openApiDocsExposeBusinessApi() throws Exception {
		mockMvc.perform(get("/v3/api-docs"))
				...
				.andExpect(jsonPath("$.paths['/api/v1/auth/token/refresh']", notNullValue()))
				.andExpect(jsonPath("$.paths['/api/v1/auth/logout']", notNullValue()))
				...
				.andExpect(jsonPath("$.paths['/api/v1/accounts/{accountId}/portfolio/history']", notNullValue()))
				...
				.andExpect(jsonPath("$.paths['/api/v1/accounts/{accountId}/tax/refund-status/sync']", notNullValue()))
				.andExpect(jsonPath("$.paths['/api/v1/accounts/{accountId}/audit/events']", notNullValue()))
